...
This file is part of SEAL API eMRTD Identity Source (SEAL emrtd-is).
...
public class ConfMngrConnServiceImp implements ConfMngrConnService
{
	...
	@Value("${emrtd-is.cm.getExternalEntitiesPath}")
	private String getExternalEntitiesPath;
	
	@Value("${emrtd-is.cm.getEntityMetadataSetPath}")
	private String[] getEntityMetadataSetPath;
	
	@Value("${emrtd-is.cm.getEntityMetadataPath}")
	private String[] getEntityMetadataPath;
	
	@Value("${emrtd-is.cm.getAllMicroservicesPath}")
	private String getAllMicroservicesPath;
	
	@Value("${emrtd-is.cm.getMicroservicesByApiClassPath}")
	private String[] getMicroservicesByApiClassPath;
	
	@Value("${emrtd-is.cm.getInternalsPath}")
	private String getInternalsPath;
	
	@Value("${emrtd-is.cm.getConfigurationPath}")
	private String[] getConfigurationPath;
	
	@Value("${emrtd-is.cm.getAttributeSetByProfilePath}")
	private String[] getAttributeSetByProfilePath;
	
	@Value("${emrtd-is.cm.getAttributeProfilesPath}")
